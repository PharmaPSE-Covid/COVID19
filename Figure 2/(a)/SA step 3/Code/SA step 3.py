...
for scenario_number in range(n_of_scenario):
    effi_2nd =sumple_scenario.iloc[scenario_number]['efficacy']
    
    if scenario_number % timecounter == 0:
        print(str(scenario_number) + '/' + str(n_of_scenario) + ' --- ' + str(datetime.datetime.now().hour) + ':' + str(datetime.datetime.now().minute) + ':' + str(datetime.datetime.now().second))
...
I_new_file = 'I_new_' + str(n_of_scenario) + 'scenario.csv'
I_now_file = 'I_now_' + str(n_of_scenario) + 'scenario.csv'
